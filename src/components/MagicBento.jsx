...
// Use the new public asset
const fuoraSocial = '/fuora-social.png';
import socialFuora from '../assets/social-fuora.png';
    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cardData.map((card, index) => {
          const baseClassName = `magic-bento-card ${textAutoHide ? 'magic-bento-card--text-autohide' : ''} ${enableBorderGlow ? 'magic-bento-card--border-glow' : ''} ${card.image ? 'magic-bento-card--image' : ''}`;
          const cardProps = {
            className: baseClassName,
            style: {
              backgroundColor: card.image ? 'transparent' : card.color,
              '--glow-color': glowColor,
              ...(card.image && { padding: 0, overflow: 'hidden', display: 'block' })
            }
          };
